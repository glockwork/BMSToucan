...
;BMSToucan.c,98 :: 		void main() {
;BMSToucan.c,100 :: 		setup();
	CALL        _setup+0, 0
;BMSToucan.c,103 :: 		PORTC.B4 = 0;
	BCF         PORTC+0, 4 
;BMSToucan.c,104 :: 		PORTC.B5 = 0;
	BCF         PORTC+0, 5 
;BMSToucan.c,107 :: 		for(;;)
L_main0:
;BMSToucan.c,110 :: 		reset_candata();
	CALL        _reset_candata+0, 0
;BMSToucan.c,113 :: 		if (flag_ovp == 0x01) {
	MOVF        _flag_ovp+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main3
;BMSToucan.c,116 :: 		CAN_data[BMS_ERROR_BIT].B0 = 1;
	BSF         _CAN_data+6, 0 
;BMSToucan.c,117 :: 		}
L_main3:
;BMSToucan.c,118 :: 		if (flag_lvp == 0x01) {
	MOVF        _flag_lvp+0, 0 
	XORLW       1
	BTFSS       STATUS+0, 2 
	GOTO        L_main4
...
;BMSToucan.c,125 :: 		if (flag_check_bms == 0x01) {
	...
	BTFSS       STATUS+0, 2 
	GOTO        L_main5
;BMSToucan.c,130 :: 		if (BMS_buffer_idx > 0) // some data has been received but not all
	MOVF        _BMS_buffer_idx+0, 0 
	SUBLW       0
	BTFSC       STATUS+0, 0 
	GOTO        L_main6
;BMSToucan.c,132 :: 		aborted_bms_checks++; // increment the number of aborted checks
...
;BMSToucan.c,135 :: 		if (aborted_bms_checks > MAX_BMS_CHECK_ABORTS)
	...
	BTFSC       STATUS+0, 0 
	GOTO        L_main7
;BMSToucan.c,138 :: 		CAN_data[BMS_ERROR_BIT].B2 = 1; // set the comms error flag
	BSF         _CAN_data+6, 2 
;BMSToucan.c,139 :: 		CAN_data[0] = CELL_IDS[current_cell]; // set the cell number
...
;BMSToucan.c,140 :: 		aborted_bms_checks = 0; // reset the abort counter
	CLRF        _aborted_bms_checks+0 
;BMSToucan.c,141 :: 		flag_send_can = 0x01;  // send an error onto CAN
	MOVLW       1
...
;BMSToucan.c,164 :: 		}
L_main5:
;BMSToucan.c,167 :: 		while(UART1_Data_ready() && BMS_buffer_idx < BMS_QUERY_LENGTH)
L_main10:
...
;BMSToucan.c,172 :: 		}
	GOTO        L_main10
L_main11:
;BMSToucan.c,175 :: 		if (BMS_buffer_idx == BMS_QUERY_LENGTH)
	MOVF        _BMS_buffer_idx+0, 0 
	XORLW       29
	BTFSS       STATUS+0, 2 
	GOTO        L_main14
;BMSToucan.c,178 :: 		CAN_data[0] = CELL_IDS[current_cell];
	MOVF        _current_cell+0, 0 
	MOVWF       R0 
	MOVF        _current_cell+1, 0 
	MOVWF       R1 
	...
	TBLRD*+
	MOVFF       TABLAT+0, _CAN_data+0
;BMSToucan.c,186 :: 		cell_values[current_cell][0] =
	MOVLW       3
	MOVWF       R2 
	MOVF        _current_cell+0, 0 
	MOVWF       R0 
...
L__main29:
	...
	MOVF        R1, 0 
	MOVWF       FLOC__main+1 
;BMSToucan.c,189 :: 		(BMS_buffer[BMS_V1_B2] << 8) | BMS_buffer[BMS_V1_B1]
	...
	MOVLW       0
	IORWF       R1, 1 
;BMSToucan.c,190 :: 		) * CELL_V_MULTIPLIER
...
;BMSToucan.c,191 :: 		);
	...
	MOVLW       0
	MOVWF       POSTINC1+0 
;BMSToucan.c,192 :: 		CAN_data[V1_bit] = cell_values[current_cell][0];
	MOVLW       3
	MOVWF       R2 
	MOVF        _current_cell+0, 0 
	MOVWF       R0 
...
L__main31:
	...
	MOVF        POSTINC0+0, 0 
	MOVWF       _CAN_data+1 
;BMSToucan.c,194 :: 		cell_values[current_cell][1] =
	MOVLW       2
	ADDWF       R0, 0 
	MOVWF       FLOC__main+0 
	MOVLW       0
	ADDWFC      R1, 0 
	MOVWF       FLOC__main+1 
;BMSToucan.c,197 :: 		(BMS_buffer[BMS_V2_B2] << 8) | BMS_buffer[BMS_V2_B1]
	...
	MOVLW       0
	IORWF       R1, 1 
;BMSToucan.c,198 :: 		) * CELL_V_MULTIPLIER
	CALL        _Word2Double+0, 0
	MOVLW       92
	MOVWF       R4 
	MOVLW       143
...
;BMSToucan.c,199 :: 		);
	...
	MOVLW       0
	MOVWF       POSTINC1+0 
;BMSToucan.c,200 :: 		CAN_data[V2_bit] = cell_values[current_cell][1];
	MOVLW       3
	MOVWF       R2 
	MOVF        _current_cell+0, 0 
	MOVWF       R0 
...
L__main33:
	...
	MOVF        POSTINC0+0, 0 
	MOVWF       _CAN_data+2 
;BMSToucan.c,202 :: 		cell_values[current_cell][2] =
	MOVLW       4
	ADDWF       R0, 0 
	MOVWF       FLOC__main+0 
	MOVLW       0
	ADDWFC      R1, 0 
	MOVWF       FLOC__main+1 
;BMSToucan.c,205 :: 		(BMS_buffer[BMS_V3_B2] << 8) | BMS_buffer[BMS_V3_B1]
	...
	MOVLW       0
	IORWF       R1, 1 
;BMSToucan.c,206 :: 		) * CELL_V_MULTIPLIER
	CALL        _Word2Double+0, 0
	MOVLW       92
	MOVWF       R4 
	MOVLW       143
...
;BMSToucan.c,207 :: 		);
	...
	MOVLW       0
	MOVWF       POSTINC1+0 
;BMSToucan.c,208 :: 		CAN_data[V3_bit] = cell_values[current_cell][2];
	MOVLW       3
	MOVWF       R2 
	MOVF        _current_cell+0, 0 
	MOVWF       R0 
...
L__main35:
	...
	MOVF        POSTINC0+0, 0 
	MOVWF       _CAN_data+3 
;BMSToucan.c,210 :: 		cell_values[current_cell][3] =
	MOVLW       6
	ADDWF       R0, 0 
	MOVWF       FLOC__main+0 
	MOVLW       0
	ADDWFC      R1, 0 
	MOVWF       FLOC__main+1 
;BMSToucan.c,213 :: 		(BMS_buffer[BMS_V4_B2] << 8) | BMS_buffer[BMS_V4_B1]
	...
	MOVLW       0
	IORWF       R1, 1 
;BMSToucan.c,214 :: 		) * CELL_V_MULTIPLIER
	CALL        _Word2Double+0, 0
	MOVLW       92
	MOVWF       R4 
	MOVLW       143
...
;BMSToucan.c,215 :: 		);
	...
	MOVLW       0
	MOVWF       POSTINC1+0 
;BMSToucan.c,216 :: 		CAN_data[V4_bit] = cell_values[current_cell][3];
	MOVLW       3
	MOVWF       R2 
	MOVF        _current_cell+0, 0 
	MOVWF       R0 
...
L__main37:
	...
	MOVF        POSTINC0+0, 0 
	MOVWF       _CAN_data+4 
;BMSToucan.c,220 :: 		flag_send_can = 0x01;
	MOVLW       1
	MOVWF       _flag_send_can+0 
;BMSToucan.c,221 :: 		}
L_main14:
